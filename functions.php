...
function langlist () {
   echo '<ul id="change_language">';
   if (qtrans_getLanguage() == 'en') {
      echo '<li><a href="' . qtrans_convertURL(curPageURL(), 'nl') . '" class="qtrans_flag_nl qtrans_flag_and_text">Nederlands</a></li>';
   } else {
      echo '<li><a href="' . qtrans_convertURL(curPageURL(), 'en') . '" class="qtrans_flag_en qtrans_flag_and_text">English</a></li>';
   }
   echo '</ul>';
}
...
function new_excerpt_more( $more ) {
	global $post;
	if (is_front_page()) {
		return '... <a class="moretag" href="'. get_permalink($post->ID) . '"><!--:en-->more<!--:--><!--:nl-->meer<!--:--></a>';
	} else {
		return '...';
	}
}
